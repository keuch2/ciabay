...
<html lang="es">
    <head>
        ...
        <!-- Scripts (Alpine is bundled via Vite) -->
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 flex" x-data="{ sidebarOpen: true }">
            <!-- Sidebar -->
            <aside class="bg-gray-900 text-white transition-all duration-300 flex-shrink-0 flex flex-col sticky top-0"
                ...
                <!-- Nav Links -->
                <nav class="flex-1 overflow-y-auto mt-4 space-y-1 px-2 pb-4">
                    @php
                        $navItems = [
                            ...
                            ['route' => 'admin.tracking.edit', 'label' => 'Seguimiento', 'icon' => 'M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3', 'permission' => 'settings.manage'],
                            ['route' => 'admin.code.edit', 'label' => 'Código', 'icon' => 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4', 'permission' => 'settings.manage'],
                            ['route' => 'admin.store-config.edit', 'label' => 'Config. Tienda', 'icon' => 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z', 'permission' => 'settings.manage'],
                            ['route' => 'admin.catalog-config.edit', 'label' => 'Config. Catálogos', 'icon' => 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', 'permission' => 'settings.manage'],
                ...
                <!-- User info at bottom -->
                <div class="flex-shrink-0 p-4 border-t border-gray-700" x-show="sidebarOpen">
